...
SceneJS.Types.addType("animatedNode", {
...
//	autoLoadPath: "",
    ...
    initEvents: function () {
        ...
        canvas.addEventListener('keydown', function (e) {
            _this.events.trigger('keydown', [e]);
        }, true);
            ...
            try {
                ...
                this.scene = {
                    ...
                    nodes: [{
                        type: 'lookAt',
                        id: 'main-lookAt',
                        eye: (typeof options.eye == 'object' ? options.eye : {x: 0, y: 10, z: 10}),
                        look: (typeof options.look == 'object' ? options.look : {x: 0, y: 0, z: 0}),
